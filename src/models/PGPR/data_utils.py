...
class Dataset(object):
    ...
    def load_product_relations(self):
        ...
        if self.dataset_name == ML1M:
            ...
            product_relations = edict(
                in_album=("album_p_al.txt.gz", self.album),
                has_micro_genre=("micro_genre_p_mi.txt.gz",self.micro_genre),
                created_by=('artist_p_ar.txt.gz', self.artist),
                has_genre=('genre_p_ge.txt.gz', self.genre)
            )
